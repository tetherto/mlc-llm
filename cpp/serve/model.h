...
class Model : public ObjectRef {
 public:
   ...
   */
  __declspec(dllexport)  static Model
      Create(String reload_lib_path, String model_path,
   ...
   */
  static __declspec(dllexport)  Result<picojson::object> LoadModelConfig(const String& model_path);
